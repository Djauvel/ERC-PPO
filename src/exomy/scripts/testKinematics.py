...
#import gym
import math
#from utils.kinematicsCPU import Ackermann
...
config_filename = '/home/made/Documents/isaac_rover_physical-main/src/exomy/config/exomy.yaml'
robot = Rover(config_filename)
